	...
	return (
		<SafeAreaView>	
			<View style={[styles.container, styles.row, styles.justifyContentSpaceEvenly]}>
				...
				/>
				<BottomBarIcons
					onPress={() => nav.current.navigate('ProfessorScheduleStack')}	
					routeName='ProfessorScheduleStack'
					isActualScreen={routeName === 'ProfessorScheduleStack'}
